...
const Tx_pin: SerialPin = SerialPin.P12 // To Rx pin of ESP-01
const Rx_pin: SerialPin = SerialPin.P8 // To Tx pin of ESP-01
const LED_pin: DigitalPin = DigitalPin.P2 // pin for LED control
const SSID_1: string = "-----" // wifi router ssid for station mode
const PASSWORD_1: string = "-----" //wifi router password for station mode
const SSID_2: string = "Sir-v2" // AP server ssid for AP mode
const PASSWORD_2: string = "helloworld" // AP password for AP mode (at least 8 characters)
